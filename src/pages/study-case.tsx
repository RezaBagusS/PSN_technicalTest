...
const StudyCasePage = () => {
    ...
    return (
        <>
            <DashboardLayout>
                <div className="p-0">
                    <Card title="Comment Management System" className="shadow-md text-center md:text-start">
                        <div className="max-w-full text-start">
                            ...
                            <h2 className="md:text-2xl font-semibold mt-6 mb-3">Features</h2>
                            ...
                            <h2 className="md:text-2xl font-semibold mt-6 mb-3">Tech Stack</h2>
                            <ul className="list-disc pl-6 mb-4 text-sm md:text-base">
                            ...
                            <h2 className="md:text-2xl font-semibold mt-6 mb-3">License</h2>
                            <p className="mb-4 text-sm md:text-base">
                                MIT License. See <code>LICENSE</code> for details.
                            </p>

                            <h2 className="md:text-2xl font-semibold mt-6 mb-3">Contact</h2>
                            <p className="mb-4 text-sm md:text-base">
